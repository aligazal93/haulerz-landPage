...
export default function Banner({ isArabic }) {
  return (
    <section className="container mt-[-100px] lg:mt-[-100px]">
      ...
      >
        <div
          className={`relative flex items-center z-10 max-w-[520px] text-center ${
        ...
        >
          <h2 className="text-[#121212] text-custom20 lg:text-[26px] font-[800] leading-[1.9]">
            {isArabic ? (
              <>
                سواء كنت فرد أو صاحب شركة،
                <br />
                هولرز توفرلك حلول ذكية لشحناتك تتناسب مع احتياجك
              </>
            ) : (
              <>
                Whether you are individual or business owner,
                <br />
                Haulerz provides smart shipping solutions that fit your needs
              </>
            )}
          </h2>
        </div>
